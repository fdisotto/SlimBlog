...
-- Dump della struttura del database slimblog
CREATE DATABASE IF NOT EXISTS `slimblog` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `slimblog`;


-- Dump della struttura di tabella slimblog.posts
...
-- Dump dei dati della tabella slimblog.posts: ~0 rows (circa)
DELETE FROM `posts`;
...
-- Dump dei dati della tabella slimblog.settings: ~1 rows (circa)
...
-- Dump della struttura di tabella slimblog.users
...
-- Dump dei dati della tabella slimblog.users: ~1 rows (circa)
DELETE FROM `users`;
